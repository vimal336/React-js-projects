              ...
              <div className="grid grid-cols-2 gap-4">
                {["React", "Tailwind CSS", "Next.js", "Node.js", "Git"].map(
                  (skill, index) => (
                    <div
                      key={index}
                      className="skill-tag bg-blue-100 text-blue-700 rounded-full px-4 py-2 text-center font-medium hover:bg-blue-200 transform transition duration-300 ease-in-out hover:scale-105 animate-fade-in"
